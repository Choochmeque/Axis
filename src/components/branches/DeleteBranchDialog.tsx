      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className={contentClass}>
          ...
          <div className={bodyClass}>
            ...
            <div className={infoBoxClass}>
              ...
              <div className="flex justify-between text-[13px] py-1">
                ...
                <span className="text-(--text-primary) font-medium">{branch.last_commit_summary}</span>
              </div>
            </div>
          ...
          <div className={footerClass}>
            ...
            <button
              className={cn(btnClass, "bg-error border border-error text-white hover:not-disabled:bg-[#c0392b] disabled:opacity-50 disabled:cursor-not-allowed")}
