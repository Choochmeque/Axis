...
interface RevertCommitDialogContentProps {
  onClose: () => void;
  onRevertComplete?: (result: RevertResult) => void;
  commits: Commit[];
...
function RevertCommitDialogContent({
  onClose,
  onRevertComplete,
  commits,
  closeHandlerRef,
}: RevertCommitDialogContentProps) {
  ...
  }, [closeHandlerRef, isLoading, onClose]);
