...
export function CherryPickDialog({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      {isOpen && (
        <CherryPickDialogContent
          onClose={onClose}
          onCherryPickComplete={onCherryPickComplete}
          commits={commits}
        />
      )}
    </Dialog>
...
interface CherryPickDialogContentProps {
  onClose: () => void;
  onCherryPickComplete?: (result: CherryPickResult) => void;
  commits: Commit[];
}

function CherryPickDialogContent({
  onClose,
  onCherryPickComplete,
  commits,
}: CherryPickDialogContentProps) {
